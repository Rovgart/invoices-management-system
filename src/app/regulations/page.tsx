        ...
        <div className="prose prose-gray max-w-none space-y-8">
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed mt-4">
              ...
              wprowadzania nowych funkcjonalności oraz czasowego wyłączenia
              części funkcji w celach konserwacyjnych.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              Zasady przetwarzania danych osobowych Użytkowników zostały
              określone w Polityce Prywatności dostępnej w Aplikacji.
              Korzystanie z Usługi wymaga akceptacji Polityki Prywatności.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed mt-4">
              Użytkownik nabywa jedynie prawo do korzystania z Aplikacji zgodnie
              z Regulaminem, bez prawa do jej kopiowania, modyfikowania lub
              rozpowszechniania.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              W sprawach związanych z Regulaminem lub działaniem Aplikacji
              prosimy o kontakt:
            </p>
          ...
          <section className="border-t border-border pt-8 mt-12">
            <p className="text-sm text-muted-foreground italic">
              ...
              {new Date().toLocaleDateString("pl-PL")}i został sporządzony
